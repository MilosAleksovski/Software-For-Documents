...
public class SlotCommand extends AddDeviceComand {
    public SlotCommand(Slot slot, PageModel pageModel, CommandsEnum commandtype, Point position, Dimension dimension, double angle) {
