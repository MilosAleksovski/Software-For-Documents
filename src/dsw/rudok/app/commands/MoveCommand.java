...
public class MoveCommand extends AddDeviceComand {
    public MoveCommand(Slot slot, PageModel pageModel, CommandsEnum commandtype, Point position, Dimension dimension, double angle) {
